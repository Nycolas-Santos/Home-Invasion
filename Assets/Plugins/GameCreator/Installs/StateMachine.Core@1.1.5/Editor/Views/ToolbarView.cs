...
namespace NinjutsuGames.StateMachine.Editor
{
    public class ToolbarView : VisualElement
    {
        ...
        private List<ToolbarButtonData> leftButtonDatas = new List<ToolbarButtonData>();
        private List<ToolbarButtonData> rightButtonDatas = new List<ToolbarButtonData>();
        ...
        protected virtual void AddButtons()
        {
            ...
            // bool processorVisible = graphView.GetPinnedElementStatus<ProcessorView>() != DropdownMenuAction.Status.Hidden;
            // showProcessor = AddToggle("Show Processor", processorVisible, v => graphView.ToggleView<ProcessorView>());
            bool exposedParamsVisible = graphView.GetPinnedElementStatus<BlackboardView>() != DropdownMenuAction.Status.Hidden;
            showParameters = AddToggle("Blackboard", exposedParamsVisible, v => graphView.ToggleView<BlackboardView>());
