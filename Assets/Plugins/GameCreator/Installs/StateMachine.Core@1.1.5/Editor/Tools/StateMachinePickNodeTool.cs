...
namespace NinjutsuGames.StateMachine.Editor
{
    public class StateMachinePickNodeTool : TNodeNamePickTool
    {
        ...
        private Dictionary<string, string> GetVariablesList(Object asset)
        {
            ...
            // NameList names = variable.GetType().GetField("m_NameList", BindingFlags.NonPublic | BindingFlags.Instance)?.GetValue(variable) as NameList;

            return FilterNames(variable.nodes.FindAll(n => n is ActionsNode or ConditionsNode));
        }
    }
}