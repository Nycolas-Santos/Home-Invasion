...
namespace NinjutsuGames.StateMachine.Editor
{
    public class StateMachinePickTool : TNamePickTool
    {
        ...
        public StateMachinePickTool(ObjectField asset, SerializedProperty property)
            : base(asset, property, true, false, ValueNull.TYPE_ID)
        { }
        
        public StateMachinePickTool(ObjectField asset, SerializedProperty property, IdString typeID, bool allowCast)
        ...
        {
            StateMachineAsset variable = asset as StateMachineAsset;
