...
namespace NinjutsuGames.StateMachine.Editor
{
    ...
    public class ExposedParameterSettingsDrawer : PropertyDrawer
    {
        ...
        protected static StateMachineAsset GetGraph(SerializedProperty property) => property.serializedObject.FindProperty("graph").objectReferenceValue as StateMachineAsset;
