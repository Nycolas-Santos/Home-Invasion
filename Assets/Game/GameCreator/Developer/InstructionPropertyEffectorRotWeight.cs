...
[Title("Change Effector Rotation Weight (Final IK)")]
[Description("Changes the weight value of an Effector (Final IK)")]

[Category("Animation Rigging/Properties/Change Effector Rotation Weight")]
...
[Serializable]
public class InstructionPropertyEffectorRotWeight : Instruction
{
    // MEMBERS: -------------------------------------------------------------------------------
    ...
    public override string Title => 
        $"Rotation Weight from {this.m_Rig}'s {this.m_Effector.ToString()} to {this.m_Value}";
    ...
    protected override async Task Run(Args args)
    {
        ...
        var valueSource = rig.solver.GetEffector(this.m_Effector).rotationWeight;
        ...
        ITweenInput tween = new TweenInput<float>(
            ...
            (a, b, t) => rig.solver.GetEffector(this.m_Effector).rotationWeight = Mathf.Lerp(a, b, t),
            Tween.GetHash(typeof(FullBodyBipedIK), "property:rotation-rig-weight"),
